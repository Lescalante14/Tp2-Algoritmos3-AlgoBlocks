...
public class ControladorBloqueMoverArriba implements EventHandler<ActionEvent> {
    ...
    public ControladorBloqueMoverArriba(ControladorEjecutarAlgoritmo controladorEjecutarAlgoritmo) {
    ...
    public void handle(ActionEvent actionEvent) {
        controladorEjecutarAlgoritmo.agregarBloque(new BloqueMoverArriba());
